...
router.route("/:tweetId").get(tweetController.getTweet).patch(authController.protect,upload.single("mediaUrl"),tweetController.updateTweet).delete(authController.protect,tweetController.deleteTweet)
