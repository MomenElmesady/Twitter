...
exports.verify = catchAsync(async (req, res, next) => {
  ...
  token = crypto
    ...
    .update(token)
    .digest('hex');
  // its not important becouse we make sure that the token is in database and this token created by this email we can get the user through the token stored in database directly 
