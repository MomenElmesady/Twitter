...
exports.createBlock = catchAsync(async (req, res, next) => {
  ...
  sendResponse(res, null, "block happened successfully", 201);
});
...
exports.deleteBlock = catchAsync(async (req, res, next) => {
  ...
  sendResponse(res, null, "block deleted successfully", 200);
});
...
exports.isBlock = catchAsync(async (req, res, next) => {
  ...
  if (blockOne || blockTwo) {
    return next(new appError("Can't follow when there is a block", 403));
  }
  next();
});
